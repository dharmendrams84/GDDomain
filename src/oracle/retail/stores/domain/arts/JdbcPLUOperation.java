    ...
    implements ARTSDatabaseIfc, ProductGroupConstantsIfc, DiscountRuleConstantsIfc
{
    ...
    {
    	System.out.println("inside execute JdbcPLUOperation.java");
    ...
    public PLUItemIfc[] selectPLUItem(JdbcDataConnection dataConnection, List<SQLParameterIfc> qualifiers, LocaleRequestor locale)
            throws DataException
    {
    	System.out.println("Inside selectPLUItem JdbcPLUOperation.java");
    ...
    {
    	System.out.println("--inside buildSelectPLUItemSQL--");
        SQLSelectStatement sql = new SQLSelectStatement();
...
//        ic.setSerialEntryTime("StoreReceiving"); //TODO
    ...
    protected void applyManufacturer(JdbcDataConnection dataConnection, PLUItemIfc pluItem,
        ...
        throws DataException
    {
    	System.out.println("Inside applyManufacturer JdbcPLUOperation ");
  ...
  /*  public static  void readCpnAttrDtls(JdbcDataConnection dataConnection,PLUItemIfc pluItem)
            throws DataException
    {
    	
    	 logger.info("inside readCpnAttrDtls JdbcPLUOperation");
    	 System.out.println("inside readCpnAttrDtls JdbcPLUOperation for item id "+pluItem.getItemID());
       ...
       // sql.addColumn("COUPON_ID");
        ...
        logger.info( "from readCpnAttrDtls view couponId  "+pluItem.getItemID());
        ...
        try
        {
            ...
            logger.info("sqlQuery for coupon To Run from JdbcPLUOperation "+sqlToRun);
            ...
            while (rs.next())
            {
            	...
            	pluItem.setLoylCpnType(getSafeString(rs, 1));
            	pluItem.setItmApplyTo(getSafeString(rs, 2));
            	pluItem.setMinMonthlyThrhold(new BigDecimal(getSafeString(rs, 3)));
            	pluItem.setMaxMonthlyThrhold(new BigDecimal(getSafeString(rs, 4)));
            	pluItem.setMaxDiscAmount(new BigDecimal(getSafeString(rs, 5)));
            	
            	
            	logger.info("Details from readCpnAttrDtls1 JdbcPLUOperation  "+getSafeString(rs, 1)+" : "+getSafeString(rs, 2)+" : "+getSafeString(rs, 3)+ " : "+getSafeString(rs,4)); 
            	
            	System.out.println("Details from readCpnAttrDtls1 JdbcPLUOperation for item id  "+itemId+"  " +getSafeString(rs, 1)+" : "+getSafeString(rs, 2)+" : "+getSafeString(rs, 3)+ " : "+getSafeString(rs,4));
